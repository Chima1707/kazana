...
function registerTransformers (server, plugin, transformersMap) {
  ...
  sourceIds.forEach(function (sourceId) {
    ...
    server.app.admin.rawData.db.changes({
      since: 'now',
      live: true,
      include_docs: true
    })
      .on('create', handleDataReport.bind(null, server, plugin, indicatorName, transform, 'add'))
      .on('update', handleDataReport.bind(null, server, plugin, indicatorName, transform, 'update'))
      .on('delete', handleDataReport.bind(null, server, plugin, indicatorName, transform, 'remove'))
